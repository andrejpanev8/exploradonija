    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) 
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                logger.warn("JWT Token is invalid or cannot be parsed: " + e.getMessage());
            }
        } else {
            // logger.trace("JWT Token does not begin with Bearer String or is missing for path: " + request.getRequestURI());
        }
